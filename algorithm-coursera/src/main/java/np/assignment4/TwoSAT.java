package np.assignment4;

import graph.assignment1.DirectedGraph;
import graph.assignment1.KosarajuSCC;
...
public class TwoSAT {
    ...
    public static boolean isSatisfy(DirectedGraph graph, int variables) {
    ...
    public static void run(String path) throws IOException {
        ...
        DirectedGraph graph = new DirectedGraph(vertices * 2);
